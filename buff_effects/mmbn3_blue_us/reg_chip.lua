...
function REGCHIP.new()
    ...
    if #all_non_regged_chips_indices ~= 0 then
        local random_idx = all_non_regged_chips_indices[gauntlet_data.math.random_buff_activation(1, #all_non_regged_chips_indices)] 
        ...
        if is_chip_mega or is_chip_giga then
            random_idx = all_non_regged_chips_indices[gauntlet_data.math.random_buff_activation(1, #all_non_regged_chips_indices)] 
        end
