...
function NERF_VIRUS_GROUP.new()
    ...
    --    new_buff.entity_family = entity_family--POSSIBLE_ENTITIES[gauntlet_data.math.random_buff_activation(#POSSIBLE_ENTITIES)]
    ...
    new_buff.entity_family = POSSIBLE_ENTITIES[gauntlet_data.math.random_buff_activation(#POSSIBLE_ENTITIES)]
