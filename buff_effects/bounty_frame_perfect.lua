...
function BOUNTY_FRAME_PERFECT:on_finish_battle(state_logic, gauntlet_data)
    ...
    if (self.total_fight_counter + 1) > NUM_BATTLES then
        ...
        self.damage_string_list[NUM_BATTLES] = tostring(self.last_battle_time)
    else
        self.damage_string_list[self.total_fight_counter + 1] = tostring(self.last_battle_time)
    end
