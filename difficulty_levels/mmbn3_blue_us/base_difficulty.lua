...
function BASE_DIFFICULTY.activate()

    GAUNTLET_DEFS.ROUNDS_PER_BUFF_DROP = 5
    --GAUNTLET_DEFS.HP_INCREASE_PER_ROUND[1] = 50

    gauntlet_data.mega_max_hp = 150
    ...
    GAUNTLET_DEFS.DROP_COMMON_CUMULATIVE_CHANCE = 70
    GAUNTLET_DEFS.DROP_RARE_CUMULATIVE_CHANCE = 90
    GAUNTLET_DEFS.DROP_SUPER_RARE_CUMULATIVE_CHANCE = 97
    GAUNTLET_DEFS.DROP_ULTRA_RARE_CUMULATIVE_CHANCE = 100
   
    print("Base Difficulty activated.")

end


BASE_DIFFICULTY.NAME = "Base Difficulty"
BASE_DIFFICULTY.DESCRIPTION = "Buff every 5 battles, 150 starting HP\n5 MegaChip limit."
